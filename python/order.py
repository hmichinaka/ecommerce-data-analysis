...
class Order:
    ...
    def get_number_products(self):
        ...
        """
        data = self.data
        products = data['order_items'].groupby('order_id', as_index=False)\
    ...
    def get_number_sellers(self):
        ...
        """
        data = self.data
        sellers = data['order_items'].groupby('order_id')['seller_id']\
                    .nunique().reset_index()
    ...
    def get_price_and_freight(self):
        ...
        """
        data = self.data
        price_freight = data['order_items'].groupby('order_id',as_index=False)\
    ...
    def get_distance_seller_customer(self):
        ...
        sellers_geo = sellers.merge(geo, how='left',
        ...
        customers_geo = customers.merge(geo, how='left',
        ...
        customers_sellers = customers.merge(orders, on='customer_id')\
            ...
            [['order_id', 'customer_id','customer_zip_code_prefix',
